...
## Disable Dark Mode{.doc-toc-heading}
**Dark mode** is already activated. If you don't want to use this feature. It can be turned off for HTML and SCSS below :
- **HTML** From parent directory <code class="folder">Glowing</code>. Go to file <code class="file">config.yaml</code>. Find **params** >> **enableDarkMode**. Configuration is **false**.
- **SCSS** From parent directory <code class="folder">Glowing/src/assets/scss</code>. Go to file <code class="file">_theme-variables.scss</code>. Find variable **$enable-dark-mode** . Configuration is **false**.

## Dark mode{.doc-toc-heading}
...
{{< docs/example class="d-flex justify-content-between" >}}
...
### Enable dark mode{.doc-toc-heading}
...
<html lang="en" data-bs-theme="dark">
  <head>
    ...
    <link href="{{< docs/param "cdn.css" >}}" rel="stylesheet" integrity="{{< docs/param "cdn.css_hash" >}}" crossorigin="anonymous">
  </head>
  <body>
    <h1>Hello, world!</h1>
    <script src="{{< docs/param "cdn.js_bundle" >}}" integrity="{{< docs/param "cdn.js_bundle_hash" >}}" crossorigin="anonymous"></script>
  </body>
</html>
```
...
### Building with Sass{.doc-toc-heading}
...
{{< docs/example lang="js" show_preview="false" >}}
{{< js.inline >}}
{{- readFile (path.Join "src/assets/js/color-modes.js") -}}
{{< /js.inline >}}
{{< /docs/example >}}
...
{{< docs/scss-docs name="root-dark-mode-vars" file="scss/bootstrap/_root.scss" >}}
...
{{< docs/scss-docs name="sass-dark-mode-vars" file="src/assets/scss/_theme-variables-dark.scss" >}}
...
{{< docs/scss-docs name="color-mode-mixin" file="scss/bootstrap/mixins/_color-mode.scss" >}}

...
{{< docs/callout info >}}
{{< docs/partial "docs/callouts/info-prefersreducedmotion.md" >}}
{{< /docs/callout >}}
...
### Flush{.doc-toc-heading}

Add `.accordion-flush` to remove some borders and rounded corners to render accordions edge-to-edge with their parent container.

{{< docs/example class="bg-body-secondary" >}}
...
{{< docs/scss-docs name="accordion-css-vars" file="scss/bootstrap/_accordion.scss" >}}

### Sass variables{.doc-toc-heading}

{{< docs/scss-docs name="accordion-variables" file="src/assets/scss/_theme-variables.scss" >}}

...
Dropdowns are built on a third party library, [Popper](https://popper.js.org/), which provides dynamic positioning and viewport detection. Be sure to include [popper.min.js]() before Bootstrap's JavaScript or use `bootstrap.bundle.min.js` / `bootstrap.bundle.js` which contains Popper. Popper isn't used to position dropdowns in navbars though as dynamic positioning isn't required.

## Accessibility{.doc-toc-heading}
...
## Dark dropdowns{.doc-toc-heading}

{{< docs/deprecated-in "5.3.0" >}}

Opt into darker dropdowns to match a dark navbar or custom style by adding `.dropdown-menu-dark` onto an existing `.dropdown-menu`. No changes are required to the dropdown items.

{{< docs/callout-deprecated-dark-variants "dropdown-menu" >}}
...
## Menu alignment{.doc-toc-heading}
...
### Responsive alignment{.doc-toc-heading}
...
### Alignment options{.doc-toc-heading}
...
<div class="btn-group dropstart py-2">
  <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    Dropstart
  </button>
  <ul class="dropdown-menu">
...
<div class="btn-group dropend py-2">
  <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    Dropend
  </button>
  <ul class="dropdown-menu">
...
<div class="btn-group dropup py-2">
  <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    Dropup
  </button>
  <ul class="dropdown-menu">
...
## Menu content{.doc-toc-heading}

### Headers{.doc-toc-heading}
...
## Dropdown options{.doc-toc-heading}
...
### Auto close behavior{.doc-toc-heading}
...
{{< docs/scss-docs name="dropdown-css-vars" file="scss/bootstrap/_dropdown.scss" >}}
...
{{< docs/scss-docs name="dropdown-dark-css-vars" file="scss/bootstrap/_dropdown.scss" >}}

### Sass variables{.doc-toc-heading}

Variables for all dropdowns:

{{< docs/scss-docs name="dropdown-variables" file="scss/bootstrap/_variables.scss" >}}

Variables for the [dark dropdown](#dark-dropdowns):

{{< docs/scss-docs name="dropdown-dark-variables" file="scss/bootstrap/_variables.scss" >}}

Variables for the CSS-based carets that indicate a dropdown's interactivity:

{{< docs/scss-docs name="caret-variables" file="scss/bootstrap/_variables.scss" >}}

### Mixins{.doc-toc-heading}

Mixins are used to generate the CSS-based carets and can be found in `scss/bootstrap/mixins/_caret.scss`.

{{< docs/scss-docs name="caret-mixins" file="scss/bootstrap/mixins/_caret.scss" >}}

## Usage{.doc-toc-heading}
...
### Via data attributes{.doc-toc-heading}
...
### Via JavaScript{.doc-toc-heading}

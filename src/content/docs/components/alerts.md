...
### Additional content{.doc-toc-heading}
...
<div class="alert alert-primary d-flex align-items-center" role="alert">
  <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-4" viewBox="0 0 16 16" role="img" aria-label="Warning:">
...
<div class="alert alert-primary d-flex align-items-center" role="alert">
  <svg class="bi flex-shrink-0 me-4" role="img" aria-label="Info:"><use xlink:href="#info-fill"/></svg>
  <div>
    An example alert with an icon
  </div>
</div>
...
{{< docs/scss-docs name="alert-css-vars" file="scss/bootstrap/_alert.scss" >}}


### Sass variables{.doc-toc-heading}

{{< docs/scss-docs name="alert-variables" file="src/assets/scss/_theme-variables.scss" >}}

### Sass loop{.doc-toc-heading}

Loop that generates the modifier classes with the `alert-variant()` mixin.

{{< docs/scss-docs name="alert-modifiers" file="scss/bootstrap/_alert.scss" >}}

## JavaScript behavior{.doc-toc-heading}

### Initialize{.doc-toc-heading}
...
### Triggers{.doc-toc-heading}

{{% docs/js-dismiss "alert" %}}

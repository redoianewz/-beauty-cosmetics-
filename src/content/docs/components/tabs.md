...
## Available styles{.doc-toc-heading}

Change the style of `.nav`s component with modifiers and utilities. Mix and match as needed, or build your own.

### Horizontal alignment{.doc-toc-heading}

Change the horizontal alignment of your nav with [flexbox utilities](https://getbootstrap.com/docs/5.3/layout/grid/#horizontal-alignment}). By default, navs are left-aligned, but you can easily change them to center or right aligned.
...
### Fill and justify{.doc-toc-heading}
...
{{< /docs/example >}}
## Working with flex utilities{.doc-toc-heading}
...
## Regarding accessibility{.doc-toc-heading}
...
## Using dropdowns{.doc-toc-heading}
...
### Tabs with dropdowns{.doc-toc-heading}
...
### Pills with dropdowns{.doc-toc-heading}
...
{{< docs/scss-docs name="nav-css-vars" file="scss/bootstrap/_nav.scss" >}}

On the `.nav-tabs` modifier class:

{{< docs/scss-docs name="nav-tabs-css-vars" file="scss/bootstrap/_nav.scss" >}}

On the `.nav-pills` modifier class:

{{< docs/scss-docs name="nav-pills-css-vars" file="scss/bootstrap/_nav.scss" >}}


### Sass variables{.doc-toc-heading}

{{< docs/scss-docs name="nav-variables" file="scss/bootstrap/_variables.scss" >}}

## JavaScript behavior{.doc-toc-heading}
...
### Using data attributes{.doc-toc-heading}

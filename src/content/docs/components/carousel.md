...
## Basic examples{.doc-toc-heading}
...
<div id="carouselExample" class="carousel slide">
  <div class="carousel-inner">
    <div class="carousel-item active">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#555" background="#777" text="First slide" >}}
    </div>
    <div class="carousel-item">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#444" background="#666" text="Second slide" >}}
    </div>
    <div class="carousel-item">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#333" background="#555" text="Third slide" >}}
    </div>
  </div>
...
## Autoplaying carousels{.doc-toc-heading}
...
### Individual `.carousel-item` interval{.doc-toc-heading}
...
### Autoplaying carousels without controls{.doc-toc-heading}
...
## Disable touch swiping{.doc-toc-heading}
...
{{< docs/callout-deprecated-dark-variants "carousel" >}}
...
<div id="carouselExampleDark" class="carousel carousel-dark slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#aaa" background="#f5f5f5" text="First slide" >}}
      <div class="carousel-caption d-none d-md-block">
        <h5>First slide label</h5>
        <p>Some representative placeholder content for the first slide.</p>
      </div>
    ...
    <div class="carousel-item" data-bs-interval="2000">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#bbb" background="#eee" text="Second slide" >}}
      <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div>
    ...
    <div class="carousel-item">
      {{< docs/placeholder width="800" height="400" class="bd-placeholder-img-lg d-block w-100" color="#999" background="#e5e5e5" text="Third slide" >}}
      <div class="carousel-caption d-none d-md-block">
        <h5>Third slide label</h5>
        <p>Some representative placeholder content for the third slide.</p>
      </div>
...
## Custom transition{.doc-toc-heading}
...
{{< docs/scss-docs name="carousel-variables" file="scss/bootstrap/_variables.scss" >}}

Variables for the [dark carousel](#dark-variant):

{{< docs/scss-docs name="carousel-dark-variables" file="scss/bootstrap/_variables.scss" >}}

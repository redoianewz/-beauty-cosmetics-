...
### Modal components{.doc-toc-heading}
...
### Static backdrop{.doc-toc-heading}
...
### Scrolling long content{.doc-toc-heading}
...
### Vertically centered{.doc-toc-heading}
...
### Tooltips and popovers{.doc-toc-heading}
...
### Using the grid{.doc-toc-heading}
...
### Varying modal content{.doc-toc-heading}
...
{{< docs/example stackblitz_add_js="true" >}}
...
### Toggle between modals{.doc-toc-heading}
...
### Change animation{.doc-toc-heading}

The `$modal-fade-transform` variable determines the transform state of `.modal-dialog` before the modal fade-in animation, the `$modal-show-transform` variable determines the transform of `.modal-dialog` at the end of the modal fade-in animation.

If you want for example a zoom-in animation, you can set `$modal-fade-transform: scale(.8)`.

### Remove animation{.doc-toc-heading}
...
### Dynamic heights{.doc-toc-heading}
...
### Embedding YouTube videos{.doc-toc-heading}

Embedding YouTube videos in modals requires additional JavaScript not in Bootstrap to automatically stop playback and more. [See this helpful Stack Overflow post](https://stackoverflow.com/questions/18622508/bootstrap-3-and-youtube-in-modal) for more information.

## Optional sizes{.doc-toc-heading}
...
## Fullscreen Modal{.doc-toc-heading}
...
{{< docs/scss-docs name="modal-css-vars" file="scss/bootstrap/_modal.scss" >}}

{{< docs/scss-docs name="modal-backdrop-css-vars" file="scss/bootstrap/_modal.scss" >}}

### Sass variables{.doc-toc-heading}

{{< docs/scss-docs name="modal-variables" file="scss/bootstrap/_variables.scss" >}}

### Loop{.doc-toc-heading}

[Responsive fullscreen modals](#fullscreen-modal) are generated via the `$breakpoints` map and a loop in `scss/_modal.scss`.

{{< docs/scss-docs name="modal-fullscreen-loop" file="scss/bootstrap/_modal.scss" >}}
...
#### Passing options{.doc-toc-heading}
